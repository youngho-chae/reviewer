...
- Schema-label placeholders render as **format masks**, not label names (2026-07-07): amounts `000,000원`, counts `00건`, quantities `00개`, dates `0000.00.00`, deadlines `00월 00일 까지`, distance mask `00m` (real data `00m`/`0.0km`/`00km`, from current location). Real data follows the same format (원 suffix, no ₩ prefix).
