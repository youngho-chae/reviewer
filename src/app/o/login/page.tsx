...
export default function OwnerLogin() {
  ...
  return (
    <main className="mobile-shell px-6 pt-14 pb-10">
      ...
      <h1 className="mt-6 text-[24px] font-bold">사장님 로그인</h1>
      <p className="mt-2 text-[14px] text-muted">멤버십으로 무제한 모집하세요.</p>
      ...
      <div className="mt-6 text-center text-[14px] text-muted">
        처음이신가요? <Link href="/o/signup" className="text-ink font-medium underline">가입하기</Link>
      </div>
    </main>
  );
}
