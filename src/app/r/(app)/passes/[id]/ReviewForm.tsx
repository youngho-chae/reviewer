  ...
  return (
    <div className="mt-6 space-y-8">
      ...
      <div>
        ...
        <div className="inline-flex items-center gap-2 h-10 px-4 rounded-md bg-ink text-white text-[14px] font-semibold">
      ...
      {/* 4. 채널별 작성 조건 자가점검 */}
      <div>
        <h3 className="text-[12px] tracking-[0.18em] text-muted uppercase mb-3">4 · {CHANNEL_LABEL[channel]} 작성 조건 자가점검</h3>
