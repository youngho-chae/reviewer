...
// 캐치랭크 혜택 수치는 캐치랭크 "멤버십 안내" 표(2026-08-10 첨부)가 정본:
// 플레이스 2/20/100곳 · 키워드 분석 매일 5/20/50건 · 키워드 등록 최대 10/100/500개
// · 실시간 순위 분석 무제한 · 순위 알림톡 최대 5/20/30건 · 누적 세부로그 분석
// · 내가 쓴 캠페인 1% 적립 (표는 유료 3종만 — Free는 캐치랭크 혜택 없음).
