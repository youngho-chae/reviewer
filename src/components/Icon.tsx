...
const PATHS: Record<IconName, string> = {
  ...
  // 파이 차트 — 성과 리포트 (사장님 마이 2026-08-12)
  pie: "M11 13V4a8.5 8.5 0 1 0 8.5 8.5H11ZM14.5 2.7a8.5 8.5 0 0 1 6.8 6.8h-6.8V2.7Z",
  // 상승 막대(순위) — 캐치랭크 탭 (2026-08-12)
  rank: "M4.5 20.5v-5.5M10 20.5V10M15.5 20.5V4.5M21 20.5V13",
  // 비밀번호 표시 토글 (2026-08-18 — 가입 폼)
  eye: "M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12ZM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",
  "eye-off":
    "M4 4l16 16M10.6 6.1A9.8 9.8 0 0 1 12 6c6 0 9.5 6 9.5 6a17 17 0 0 1-3 3.6M6.4 8.3A16.4 16.4 0 0 0 2.5 12S6 18 12 18c1.2 0 2.3-.2 3.3-.6M9.9 9.9a3 3 0 0 0 4.2 4.2",
};
